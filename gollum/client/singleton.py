...
async def acompletion(
    ...
    **kwargs,
    ...
    worklist_entry = await get_singleton_client().worklist.enroll(request)
...
def completion(
    ...
    **kwargs,
    ...
    """
    WARNING: unlike litellm, this function is synchronous and will block the calling thread.
    """
    coro = acompletion(
        model=model,
        messages=messages,
    ...
    return get_singleton_client().run_coroutine_sync(coro)
